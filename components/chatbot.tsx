...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "bot",
      content: "Hola! Soy el asistente de Star Healthy Studio Fit. Como puedo ayudarte hoy?",
    },
  ])
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      console.error(error)
      let message = "Lo siento, algo salio mal. Por favor intenta de nuevo mas tarde."
